package com.muzisoft.education.utils.handler;
...
import com.muzisoft.education.web.exception.io.CIOException.CInvalidFileFormatException;
...
public class FileHandler {
    ...
    public String fileUrl(EFileManager fileManager, HttpServletRequest request) {
        return request.getContextPath() + "/files" + fileManager.getDirectoryManager().getDirPath() + "/" + fileManager.getFileName();
