...
import com.muzisoft.education.web.client.dto.GoogleProfile;
...
public class GoogleOAuthClient implements OAuthClient {
    ...
    public String getOauthRedirectURL() {
        ...
        params.put("redirect_uri", application.hostAddress() + googleRedirectUri);
    ...
    public OAuthTokenResponse getTokenInfo(String code) {
        ...
        params.add("redirect_uri", application.hostAddress() + googleRedirectUri);
