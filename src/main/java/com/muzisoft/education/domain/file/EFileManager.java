package com.muzisoft.education.domain.file;

import com.muzisoft.education.domain.base.BaseTimeEntity;
import com.muzisoft.education.domain.listener.FileListener;
...
public class EFileManager extends BaseTimeEntity {
    ...
    @GenericGenerator(name = "seq_manager_file", strategy = "com.muzisoft.education.utils.manager.SeqManager", parameters = {
