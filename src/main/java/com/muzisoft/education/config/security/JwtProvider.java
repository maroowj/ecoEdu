...
import com.muzisoft.education.web.service.security.CustomUserDetailsService;
...
public class JwtProvider {
    ...
    private static final long AD_ACCESS_TOKEN_EXPIRE_TIME = 1000 * 60 * 60 * 4 ; // 4시간 SUB/ADMIN/SUPER용
...
//    private final Long refreshTokenValidMillisecond = 15 * 1000L; //15 seconds
    ...
    public String savedLogin(User member) {
        //Access Token 생성
